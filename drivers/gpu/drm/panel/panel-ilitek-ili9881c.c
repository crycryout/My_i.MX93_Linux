...
static const struct ili9881c_instr alientek_init[] = {
	ILI9881C_SWITCH_PAGE_INSTR(3),
	ILI9881C_COMMAND_INSTR(0x01, 0x00),
	ILI9881C_COMMAND_INSTR(0x02, 0x00),
	ILI9881C_COMMAND_INSTR(0x03, 0x53),
...
static const struct drm_display_mode alientek_default_mode = {
	.clock		= 65000,				/* LCD 像素时钟，单位 KHz, 58Hz */

	.hdisplay	= 800,					/* LCD X 轴像素个数 */
	.hsync_start= 800 + 24,				/* LCD X 轴+hbp的像素个数 */
	.hsync_end	= 800 + 24 + 24,		/* LCD X 轴+hbp+hspw的像素个数 */
	.htotal		= 800 + 24 + 24 + 12,	/* LCD X 轴+hbp+hspw+hfp=860的像素个数 */

	.vdisplay	= 1280,					/* LCD Y 轴像素个数 */
	.vsync_start= 1280 + 9,				/* LCD Y 轴+vbp的像素个数 */
	.vsync_end	= 1280 + 9 + 2,			/* LCD Y 轴+vbp+vspw的像素个数 */
	.vtotal		= 1280 + 9 + 2 + 7,		/* LCD Y 轴+vbp+vspw+vfp=1298的像素个数 */
};
...
static const struct ili9881c_desc alientek_ili9881_desc = {
	.init = alientek_init,
	.init_length = ARRAY_SIZE(alientek_init),
	.mode = &alientek_default_mode,
	.mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_BURST |
		      MIPI_DSI_MODE_LPM | MIPI_DSI_MODE_NO_EOT_PACKET,
};
...
static const struct of_device_id ili9881c_of_match[] = {
	...
	{ .compatible = "alientek,ili9881", .data = &alientek_ili9881_desc }, // ALIENTEK MIPI LCD 10.1:800x1280
	{ }
};
